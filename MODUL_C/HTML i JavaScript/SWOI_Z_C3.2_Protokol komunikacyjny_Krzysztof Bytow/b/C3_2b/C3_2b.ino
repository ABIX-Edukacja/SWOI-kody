...
void setup()
{
  ...
  czujnik.begin();					// uruchamiamy bibliotękę
}
void loop()						// główna pętla
{
  ...
  Serial.print("Czujnik numer 2: ");			// wyświetlenie tekstu
  Serial.println(czujnik.getTempCByIndex(1));	// wyświetlenie tekstu - temperatury
   Serial.print("\r\n");				// wyświetlenie tekstu
